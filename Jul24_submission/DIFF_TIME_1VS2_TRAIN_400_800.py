...
sys.stdout = open('./DIFF_TIME_1VS2_TRAIN_400_END.log', 'w')
...
combined_test = pd.concat([km_test, knm_test], ignore_index=True)[400:800]
...
for i in range(len(combined_test)):
    ...
    try:
        ...
        df.to_csv("RESULT_DIFF_TIME_1VS2_TRAIN_400_800.csv", index=False)
