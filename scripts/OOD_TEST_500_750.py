...
sys.stdout = open('./OOD_TEST_500_750.log', 'w')
...
combined_test = pd.concat([km_test, knm_test], ignore_index=True)[500:750]
...
for i in range(len(combined_test)):
    ...
    try:
        ...
        df.to_csv("RESULT_OOD_TEST_500_750.csv", index=False)
