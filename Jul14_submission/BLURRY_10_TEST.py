...
sys.stdout = open('./BLURRY_10_TEST.log', 'w')

print("[BLURRY 10 TEST] Started.")

# Read in training split
km_train = pd.read_csv("Jul14_submission/pair_info/BLURRY_10_TEST_KM.csv")
knm_train = pd.read_csv("Jul14_submission/pair_info/BLURRY_10_TEST_KNM.csv")
...
for i in range(len(combined_train)):
    ...
    try:
        ...
        df.to_csv("RESULT_BLURRY_10_TEST.csv", index=False)
