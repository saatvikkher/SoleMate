...
sys.stdout = open('./OOD_TEST_300_600.log', 'w')
...
combined_test = pd.concat([km_test, knm_test], ignore_index=True)[300:600]
...
for i in range(len(combined_test)):
    ...
    try:
        ...
        df.to_csv("RESULT_OOD_TEST_300_600.csv", index=False)
