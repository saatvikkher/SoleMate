...
sys.stdout = open('./DIFF_TIME_1VS2_TEST_300_END.log', 'w')
...
combined_test = pd.concat([km_test, knm_test], ignore_index=True)[300:]
...
for i in range(len(combined_test)):
    ...
    try:
        ...
        df.to_csv("RESULT_DIFF_TIME_1VS2_TEST_300_END.csv", index=False)
